    ...
    fluid_boxes = {
      {
        ...
        volume = 1000,
        pipe_connections = {{flow_direction = "input", direction = defines.direction.south, position = {-1, 4.7}}}
      },
      {
        production_type = "input",
        pipe_picture = util.empty_sprite(),
      ...
      },
      {
        ...
        pipe_covers = pipecoverspictures(),
        volume = 100,
        pipe_connections = {{flow_direction = "output", direction = defines.direction.north, position = {-1, -4.7}}}
      },
      {
        production_type = "output",
        pipe_picture = util.empty_sprite(),
